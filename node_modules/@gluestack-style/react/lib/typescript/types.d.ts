...
export type UtilityProps<GenericComponentStyles, Variants, GenericComponentProps> = Omit<TokenizedRNStyleProps<GetRNStyles<GenericComponentStyles>>, keyof GenericComponentProps> & Omit<AliasesProps<GetRNStyles<GenericComponentStyles>>, keyof GenericComponentProps> & Partial<{
    [key in UtilityPropsCombinations<Extract<keyof GetRNStyles<GenericComponentStyles>, string>>]?: LastPart<key> extends keyof PropertyTokenType ? PropertyTokenType[LastPart<key>] extends 'sizes' ? WithSizeNegativeValue<GSConfig['tokens']> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, LastPart<key>> : PropertyTokenType[LastPart<key>] extends 'space' ? WithNegativeValue<StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[LastPart<key>]]>> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, LastPart<key>> : PropertyTokenType[LastPart<key>] extends keyof GSConfig['tokens'] ? StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[LastPart<key>]]> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, LastPart<key>> : LastPart<key> extends keyof GetRNStyles<GenericComponentStyles> ? GetRNStyles<GenericComponentStyles>[LastPart<key>] : never : LastPart<key> extends keyof GetRNStyles<GenericComponentStyles> ? GetRNStyles<GenericComponentStyles>[LastPart<key>] : never;
}> & Partial<{
    [key in UtilityPropsCombinations<keyof Aliases>]?: LastPart<key> extends keyof Aliases ? Aliases[LastPart<key>] extends keyof GetRNStyles<GenericComponentStyles> ? PropertyTokenType[Aliases[LastPart<key>]] extends 'sizes' ? WithSizeNegativeValue<GSConfig['tokens']> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, Aliases[LastPart<key>]> : PropertyTokenType[Aliases[LastPart<key>]] extends 'space' ? WithNegativeValue<StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[Aliases[LastPart<key>]]]>> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, Aliases[LastPart<key>]> : StringifyToken<keyof GSConfig['tokens'][PropertyTokenType[Aliases[LastPart<key>]]]> | ExtendRNStyle<GetRNStyles<GenericComponentStyles>, Aliases[LastPart<key>]> : never : any;
